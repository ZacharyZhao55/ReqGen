...
def main():
    ...
    parser.add_argument("--rel_file", type=str, help="knowledge graph relation file")
    ...
    for model_recover_path in glob.glob(args.model_recover_path.strip()):
        ...
        with open(args.rel_file, encoding="utf-8") as frel:
            rel_lines = [x.strip() for x in frel.readlines()]
        ...
        with tqdm(total=total_batch) as pbar:
            while next_i < len(input_lines):
                ...
                _chunk_rel = rel_lines[next_i:next_i + args.batch_size]
                ...
                with torch.no_grad():
                    ...
                    traces = model(input_ids, token_type_ids,
                                   position_ids, input_mask, task_idx=task_idx, mask_qkv=mask_qkv, knowledge_injection=kj.to(device), concept_relation=_chunk_rel, tokenizer=tokenizer)
                    # traces = model(input_ids, token_type_ids,
